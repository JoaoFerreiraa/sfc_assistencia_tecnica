...
//Variavel declarada para a importação da pesquisa, essa variavel refaz o caminho das requisições das classes
$path = './';
//
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Consultar de folha de rosto rapida | SFC</title>
    <style>
        .style {
            margin-top: 1rem;
            width: 98vw;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="z-index: 9999;">
        <a class="navbar-brand" href="index.php">SFC | Voltar</a>
