...
class Revisao
{
    ...
    public function criar(){
		...
		if($revisaoFolha !== false){
			...
			$this->adicionar_log($_SESSION['usuario']['nome'],"Máquina pronta para ser revisada","Revisao",$this->cod_folha);
	...
	public function editar(){
		...
		if($this->status == 2){
			$this->adicionar_log($_SESSION['usuario']['nome'],"A máquina voltou para o técnico","Revisao",$this->cod_folha);
		}else{
			$this->adicionar_log($_SESSION['usuario']['nome'],"Máquina pronta para geração de laudo","Revisao",$this->cod_folha);
		}
