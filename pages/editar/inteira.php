...
if (!isset($_GET['folha']) || $objUsuario->getNivel() > 2 || $objUsuario->getNivel()) {
    header("Location:../../dashboard.php");
} else {
    $objFolhaDeRosto->setCod($_GET['folha']);
    $objFolhaDeRosto->consultar_por_codigo();

    $lancamentoAlmoxarife = date('Y-d-m', strtotime($objFolhaDeRosto->getLancamento_almoxarife()));
    $entradaLaboratório = date('Y-d-m', strtotime($objFolhaDeRosto->getEntrada_laboratorio()));
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-11">
                    ...
                    <form autocomplete="off" action="../../_functionsPHP/folhaDeRosto/editarFolhaAT.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="partNumber" disabled value=<?php echo $objFolhaDeRosto->getPart_number() ?>>
                            <br><br>
                            <span>Nº Série</span>
                            <input type="text" name="nSerie" disabled value=<?php echo $objFolhaDeRosto->getNumero_serie() ?>>
                        </div>
                        <div class="form-group">
                            <span>Reincidência:</span>
                            <?php
                            if ($objFolhaDeRosto->getReincidencia() == "Não" || $objFolhaDeRosto->getReincidencia() == "NÃO" || $objFolhaDeRosto->getReincidencia() == "NAO" || $objFolhaDeRosto->getReincidencia() == "Nao") {
                        ...
                        if ($objUsuario->getNivel() > 2) {
                            ...
                            <textarea class="form-control mt-2" style="resize: none;" name="defeitosApresentado" id="" cols="10" rows="5">' . $objFolhaDeRosto->getDefeito_apresentado() . '</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <input type="date" name="saidaLab" value=<?php echo $objFolhaDeRosto->getSaida_laboratorio() ?>>
                                    <br>
                                    <input class="mt-2" type="date" name="LaudoEmitido" value=<?php echo $objFolhaDeRosto->getLaudo_emitido() ?>>
                                    <br>
                                    <input class="mt-2" type="date" name="saidaLogistica" value=<?php echo $objFolhaDeRosto->getSaida_logistica() ?>>
                                    <br>
                                </div>
                            </div>
                        </div>
