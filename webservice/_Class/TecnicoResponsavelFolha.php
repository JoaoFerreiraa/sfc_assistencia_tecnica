...
Class TecnicoResponsavelFolha{
    ...
    function criar(){
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], 'O técnico se responsabilizou pela máquina! Maquina em reparo', 'tec_responsavel', $this->cod_folha_de_rosto);
    ...
    function editar(){
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], 'Outro técnico se responsabilizou pela máquina! Maquina em reparo', 'tec_responsavel', $this->cod_folha_de_rosto);
