...
class ParadaTemporaria
{
    ...
    function criar()
    {
        ...
        if ($objConexao->Inserir($cmdSql)) {
            $this->adicionar_log($_SESSION['usuario']['cod'], 'Colocou a máquina em parada temporária por falta de componente', 'parada_temporaria', $this->cod_folha);
            return true;
        } else
            return false;
    }
    ...
    function editar()
    {
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], "Alterou o status de parada temporaria desta folha.", "parada_temporaria", $this->cod_folha);
    ...
    function removerParada()
    {
        ...
        if ($objConexao->Deletar($cmdSql)) {
            $this->adicionar_log($_SESSION['usuario']['cod'], 'Removeu a parada temporária da máquina! Máquina em reparo', 'parada_temporaria', $this->cod_folha);
            return true;
        } else
            return false;
    }
