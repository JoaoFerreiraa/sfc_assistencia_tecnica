...
require_once 'CriacaoFolhaDeRosto.php';
...
class FolhaDeRosto
{
    ...
    function getTec_responsavel_old()
    {
        return $this->tec_responsavel_old;
    }
    ...
    function criar()
    {
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], "Criou uma folha de rosto", "Folha de Rosto", ($ultima_folha[0]['cod'] + 1));
        return $objConexao->Inserir($cmdSql);
    }
    ...
    function alterar_dataEntradaLab()
    {
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], "Atualizou a data de inicio do aging", "Folha de Rosto", $this->cod);
    ...
    function consultar_por_codigo()
    {
        ...
        if (isset($resultado)) {
            ...
            $this->tec_responsavel_old = $resultado['tec_responsavel_old'];
            return $resultado;
        } else
            return false;
    }
    ...
    function procurar($procurado)
    {
        $objConexao = new Conexao();
        $cmdSql = "CALL folhaDeRosto_procurar('" . $procurado . "')";
        $resultado = $objConexao->Consultar($cmdSql);
        if (isset($resultado)) {
            return $resultado;
        } else
    ...
    function editar_por_cod_AT()
    {
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], "Atualizou a folha de rosto", "Folha de Rosto", $this->cod);
    ...
    function editar_laudo_emitido()
    {
        ...
        $this->adicionar_log($_SESSION['usuario']['cod'], "Finalizou o aging da maquina. Laudo emitido.", "Laudo Emitido e Folha de Rosto", $this->cod);
